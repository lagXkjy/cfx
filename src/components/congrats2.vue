<template>
    <div class="congrats2 wh-100 absolute">
        ...
        <div class="quan pm">仅限五芳斋门店使用</div>
        <!-- 马上使用 -->
        ...
        <div class="btn-box">
            ...
            <div @click="imme" class="btn-context wh-100 absolute flex justify-center align-center">立即领取</div>
        </div>
    </div>
</template>
...
export default {
    data(){
        function cmoney(){
            let num = ''
            if(+sessionStorage.getItem('result') == 9){
                num = '199-50'
            }else{
                num = '139-30'
            }
